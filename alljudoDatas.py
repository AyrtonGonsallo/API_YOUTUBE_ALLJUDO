...
class DataMysql:
    ...
    def saveVideo(self, video):
        ...
        curseur = self.connexion.cursor(buffered=True)
        requette = (
            "INSERT INTO youtube_data_api_videos(categorie_id, channel_id, channel_title, description, title, duration, image, tags, url, video_id,date_pub) "
    ...
    def saveLastVideo(self, video):
        ...
        curseur = self.connexion.cursor(buffered=True)
        requette = (
            "INSERT INTO youtube_data_api_last_videos(categorie_id, channel_id, channel_title, description, title, duration, image, tags, url, video_id,date_pub) "
            "VALUES (%s, %s, %s, %s,%s, %s, %s, %s, %s, %s,%s)"
        )
        curseur.execute(requette,
                        (video['categorieId'], video['channelId'], video['channelTitle'], video['description'],
